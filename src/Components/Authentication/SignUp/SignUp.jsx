...
const SignUp = () => {
    return (
      ...
      <div className="border rounded p-6 form-container">
        <h3 className="text-3xl font-semibold mt-3 mb-5 text-white">Sign Up</h3>
        <form>
          <input className="block outline-none w-full bg-transparent border-b mb-4 py-3 pl-4 text-lg" type="text" name="name" placeholder="Name" />
          ...
          <input className="block outline-none w-full bg-transparent border-b mb-4 py-3 pl-4 text-lg" type="password" name="confirmPassword" placeholder="Confirm Password" />
                  
          <input type="submit" value="Sign Up"  className="block bg-yellow-500 w-full py-3 rounded text-xl mt-16"/>
          <p className="text-white text-center mt-5 text-lg ">
            Already have an account? <Link className="text-yellow-500" to={"/login"}>Log In</Link>
          </p>
        </form>
      </div>
